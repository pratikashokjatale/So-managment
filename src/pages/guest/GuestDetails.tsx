        ...
        <Grid size={{ xs: 12, md: 4 }}>
          ...
          >
            ...
            <Box sx={{ mt: 2.5, textAlign: "center" }}>
              <Typography sx={{ fontFamily: "'Inter', system-ui, sans-serif", fontSize: "0.7rem", fontWeight: 700, color: "#334155", letterSpacing: "1px" }}>
                GUEST PASS NUMBER
              </Typography>
              <Typography sx={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "1.4rem", fontWeight: 600, color: "#475569", letterSpacing: "3px", mt: 0.5 }}>
