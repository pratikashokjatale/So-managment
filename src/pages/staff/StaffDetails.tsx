          ...
          >
            ...
            <Box
              sx={{
                height: "6px",
                background:
                  "linear-gradient(90deg, #3b82f6 0%, #10b981 50%, #7c3aed 100%)",
              }}
            />
            ...
            <Box sx={{ p: 4, textAlign: "center" }}>
              ...
              <Box
                sx={{ display: "inline-block", position: "relative", mb: 3 }}
              >
                <Avatar
                ...
                {qrImageDataUrl ? (
                  ...
                  <QRCodeSVG
                    value={
                      qrCodeToken ||
                      staff.cardNo ||
                      `STAFF_VERIFIED:${staff.cardNo}:${staff.name}:${staff.department}:${staff.facilityName}`
                    }
                    size={140}
                    level="H"
                  />
              ...
              <Typography
                variant="caption"
                color="text.secondary"
                sx={{ display: "block", mt: 2, fontWeight: 800 }}
              >
